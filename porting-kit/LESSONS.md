...
## 064. A mutation that is not reverted looks exactly like a gate that caught it
...
## 065. One byte that is not UTF-8 blinded a whole kernel table — and the fuzz target could not see it
