...
```powershell
$out  = "$env:TEMP\lsof-rs-etw-spike"
...
logman stop lsof-rs-spike -ets 2>$null
logman delete lsof-rs-spike 2>$null
# Optionally wipe the spike folder:
# Remove-Item -Recurse -Force "$env:TEMP\lsof-rs-etw-spike"
```
