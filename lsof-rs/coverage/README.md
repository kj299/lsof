...
| `coverage-matrix.toml` | The **declaration**: one `[[case]]` per real test in lsof-rs's suite — golden tests, the socket differential, and the 67-case live smoke harness. |
