...
| `coverage-matrix.toml` | The **declaration**: one `[[case]]` per real test in lsof-rs's suite — golden tests, the socket differential, and the 65-case live smoke harness. |
